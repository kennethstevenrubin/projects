...
define(["/MithrilLib/three/core/three.js"],
    function (THREE) {
        ...
        var functionLaserCannon = function LaserCannon(objectVisualParent,
            ...
            self.textureURL = strTextureURL || "/media/t0.png";
            // The number of particles in the system.
            self.numberOfParticles = iNumberOfParticles || 256;
            // Size of each texture in world coordinates.
            self.particleSize = dParticleSize || 3;
            // Size of entire system.
            self.systemSize = dSystemSize || 3;
            ...
            self.jumpMultiplier = dJumpMultiplier || 6.28;
            // The radius multipler ranges around 1 and is the distance of movement.
            self.radiusMultiplierStart = dRadiusMultiplierStart || 0.8;
            self.radiusMultiplierRange = dRadiusMultiplierRange || 0.4;
            // Percent of partciles which jump out.
            self.percentRadiusMultiplierJumper = dPercentRadiusMultiplierJumper || 1;
            self.percentRadiusMultiplierJumper /= 100;
            // Multiplier effecting the radius multiplier of jumper.
            self.radiusMultiplierJumpMultiplier = dRadiusMultiplierJumpMultiplier || 4;
            // Define the set of colors for the verticies.
            self.hueStart = dHueStart || 0.6;
            self.hueRange = dHueRange || 0.4;
            self.saturationStart = dSaturationStart || 0.5;
            self.saturationRange = dSaturationRange || 0.45;
                ...
                try {
                    ...
                    for (var i = 0; i < self.particles.length; i++) {
                        ...
                        if (particleIth.expiration < iNowMS) {
                            ...
                            var dMultiplier = self.systemSize * particleIth.multiplier * dPercent;
