...
define(["prototypes"],
    function (prototypes) {
        ...
        var functionRet = function Region(optionsOverride) {
            ...
            // Render the button to the parent canvas.
            ...
            self.options = {
                ...
                page: null,             // Owner of this object.
                opacity: 0,             // Opacity of region
                ...
                fillStyleDisabled: "#808080",  // Style to fill in disabled.
                selected: false,		// Indicates that a ButtonRounded has been selected by the user
                fillStyleSelected: "#123456",	// Style to fill in selected
                clickedDownInThisRegion: false, // Indicates that the mouse was depressed over this region.  Overrides clipping tests.
                border: {
       
                    enabled: false,     // Indicates that the boder is enabled.
                    strokeStyle: "#000000",   // Style to render the border.
                }
            };
