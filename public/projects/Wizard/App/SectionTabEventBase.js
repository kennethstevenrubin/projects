...
define(["App/SectionTabBase",
    ...
    function (SectionTabBase,
        ...
        var functionRet = function SectionTabEventBase(optionsOverride) {
            ...
            self.innerInnerInnerRender = function (contextRender) {
                ...
                try {
                    ...
                    for (var i = 0; i < self.options.renderData.length; i++) {
                        ...
                        var iAlertLevel = 0;
                        var iAlertWidth = 0;
                        if (eventIth.alerts.length > 0) {

                            for (var k = 0; k < eventIth.alerts.length; k++) {

                                // Get the kth alert.
                                var alertKth = eventIth.alerts[k];
                            ...
                            iAlertCount = eventIth.alerts.length;
            ...
            // Need some options here to handle the color differences between everyday life and dreams and goals.
            var m_options = {
