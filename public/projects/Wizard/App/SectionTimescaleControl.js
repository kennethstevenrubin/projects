        ...
        var functionRet = function SectionTimescaleControl(optionsOverride) {
            ...
            self.innerRender = function (contextRender) {
                ...
                try {
                    ...
                    contextRender.fillStyle = m_options.thumbFill;
                    contextRender.strokeStyle = m_options.thumbFill;
                    ...
                    contextRender.strokeStyle = m_options.thumbStroke;
                    contextRender.beginPath();
                ...
                try {
                    ...
                    if (self.options.mouseDown === undefined) {
                        ...
                        if (e.offsetX < self.options.windowStartX) {
                            ...
                            exceptionRet = self.options.dashboard.setCursor(m_options.cursorMotile);
                            if (exceptionRet !== null) {
                            ...
                            if (planCurrent.windowDuration === planCurrent.msDuration) {
                                ...
                                exceptionRet = self.options.dashboard.setCursor(m_options.cursorSessile);
                                if (exceptionRet !== null) {
