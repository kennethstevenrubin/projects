////////////////////////////////////////
// Page4_5 -- What is the value of ret account (self) <x>?
//
...
define(["App/prototypes",
    ...
    function (prototypes,
        ...
        var functionRet = function Page4_5(optionsOverride) {
            ...
            self.inherits(PageRowBase, {
            	...
            	rows : {
            		...
            		question: {
            			...
            			text: "What is the value of " + optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].name + "?"
            		},
            		additionalInfo: {
            			...
            			configuration: {
            				...
            				valInput: {
            					...
            					options: {
	                                ...
	                                width: 200,
	                                height: 27,
	                                value: optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].value
            					}
            				},
            				nextPinchedButton: {
            					...
            					options: {
            						...
            						click: function() {
            							...
            							try {
                                            ...
                                            self.options.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].value = self.options.wizard.standardizeMoney(entry);
            								var exceptionRet = self.options.wizard.loadPage("Page4_6");
            								if (exceptionRet !== null) {
