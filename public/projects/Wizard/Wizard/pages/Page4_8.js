////////////////////////////////////////
// Page4_8 -- What would you like to call this account?
//
...
define(["App/prototypes",
    ...
    function (prototypes,
        ...
        var functionRet = function Page4_8(optionsOverride) {
            			...
            			configuration: {
            				...
            				acctNameInput: {
            					...
            					options: {
	                                ...
	                                width: 200,
	                                height: 27,
	                                value: optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSpouse[optionsOverride.wizard.options.wizData.index].name
            					}
            				},
            				nextPinchedButton: {
            					...
            					options: {
            						...
            						click: function() {
            							...
            							try {
                                            ...
                                            self.options.wizard.options.wizData.assets.retirementAccounts.accountsSpouse[self.options.wizard.options.wizData.index].name = entry;
            			...
            			previousClick: function () {
                            ...
                            try {
                            	...
                            	if (self.options.wizard.options.wizData.index === 0) {
                            		...
                            		exceptionRet = self.options.wizard.loadPage("Page4_7");
                            		
                            	} else {
                            		
                            		self.options.wizard.options.wizData.index--;
                            		exceptionRet = self.options.wizard.loadPage("Page4_11");
                            	}
                                if (exceptionRet !== null) {
