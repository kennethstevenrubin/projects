////////////////////////////////////////
// Page6_2 -- Enter utilities monthly expenses
//
...
define(["App/prototypes",
    ...
    function (prototypes,
        ...
        var functionRet = function Page6_2(optionsOverride) {
            ...
            self.inherits(PageRowBase, {
            	...
            	rows : {
            		...
            		question: {
            			...
            			text: "How much do you spend each month on utilities?"
            		},
            		additionalInfo: {
            			
            			visible: true,
            			text: "Examples of expenses are electricity, oil/gas, water, telephone, Internet, cable or satellite TV. It's fine to make an estimate; you'll be able to refine these expenses later."
            		},
            		userAction: {
            			...
            			configuration: {
            				...
            				valInput: {
            					...
            					options: {
	                                ...
	                                width: 200,
	                                height: 27,
	                                value: optionsOverride.wizard.options.wizData.everydayLife.expenses.monthlyUtilities
            					}
            				},
            					...
            					options: {
            						...
            						click: function() {
            							...
            							try {
                                            ...
                                            self.options.wizard.options.wizData.everydayLife.expenses.monthlyUtilities = self.options.wizard.standardizeMoney(entry);
            		...
            		previousSkipLinks: {
            			...
            			skipClick: function () {
            				...
            				try {
                                ...
                                self.options.wizard.options.wizData.everydayLife.expenses.monthlyUtilities = "$";
            					var exceptionRet = self.options.wizard.loadPage("Page6_3");
                                if (exceptionRet !== null) {
