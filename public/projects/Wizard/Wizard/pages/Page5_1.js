////////////////////////////////////////
// Page5_1 -- User cannot do Other Investment Accounts in Wizard.
//
...
define(["App/prototypes",
    ...
    function (prototypes,
        ...
        var functionRet = function Page5_1(optionsOverride) {
                    ...
                    gibLabel1: {
                        ...
                        options: {
                            ...
                            label: {
                                ...
                                text: "We've found your investment accounts.",
                                lineHeight: 46,
                    ...
                    alreadyLabel: {
                        ...
                        options: {
                            ...
                            label: {
                                ...
                                text: "You've already entered information about your taxable investment accounts, and we'll use that in your plan.",
                                lineHeight: 24,
                            	...
                            	try {
                            		...
                            		var pageId;
		                          	...
		                          	if (self.options.wizard.options.wizData.collegeRiskModel !== "")
		                          		pageId = "Page4_20";
		                          	else if (self.options.wizard.options.wizData.assets.collegeAccounts.dbDataExists === true)
		                          		pageId = "Page4_12";
