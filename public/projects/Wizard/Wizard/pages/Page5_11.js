////////////////////////////////////////
// Page5_11 -- What is the value of bank account <x>?
//
...
define(["App/prototypes",
    ...
    function (prototypes,
        ...
        var functionRet = function Page5_11(optionsOverride) {
            ...
            self.inherits(PageRowBase, {
            	...
            	rows : {
            		...
            		question: {
            			...
            			text: "What is the value of " + optionsOverride.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].name + "?"
            		},
            		additionalInfo: {
            			...
            			configuration: {
            				...
            				valInput: {
            					...
            					options: {
	                                ...
	                                width: 200,
	                                height: 27,
	                                value: optionsOverride.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].value
            					}
            				},
            				nextPinchedButton: {
            					...
            					options: {
            						...
            						click: function() {
            							...
            							try {
                                            ...
                                            self.options.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].value = self.options.wizard.standardizeMoney(entry);
            								var exceptionRet = self.options.wizard.loadPage("Page5_12");
            								if (exceptionRet !== null) {
            		...
            		previousSkipLinks: {
            			...
            			previousClick: function () {
                            ...
                            try {
                                ...
                                var exceptionRet = self.options.wizard.loadPage("Page5_10");
                                if (exceptionRet !== null) {
