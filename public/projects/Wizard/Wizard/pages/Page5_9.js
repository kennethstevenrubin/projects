////////////////////////////////////////
// Page5_9 -- What would you like to call this account?
//
...
define(["App/prototypes",
    ...
    function (prototypes,
        ...
        var functionRet = function Page5_9(optionsOverride) {
            			...
            			configuration: {
            				...
            				acctNameInput: {
            					...
            					options: {
	                                ...
	                                width: 200,
	                                height: 27,
	                                value: optionsOverride.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].name
            					}
            				},
            				nextPinchedButton: {
            					...
            					options: {
            						...
            						click: function() {
            							...
            							try {
                                            ...
                                            self.options.wizard.options.wizData.assets.otherBankAccounts.accounts[self.options.wizard.options.wizData.index].name = entry;
            			...
            			previousClick: function () {
                            ...
                            try {
                            	...
                            	if (self.options.wizard.options.wizData.index === 0) {
                            		...
                            		exceptionRet = self.options.wizard.loadPage("Page5_8");
                            		
                            	} else {
                            		
                            		self.options.wizard.options.wizData.index--;
                            		exceptionRet = self.options.wizard.loadPage("Page5_12");
                            	}
                                if (exceptionRet !== null) {
