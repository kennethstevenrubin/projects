////////////////////////////////////////
// Page7_6a -- Risk Model for Retirement Assets
//
...
define(["App/prototypes",
        ...
        var functionRet = function Page7_6a(optionsOverride) {
            ...
            self.inherits(PageRowBase, {
            	...
            	rows : {
            		...
            		breadcrumb: {
            			...
            			text: ">  Everyday Living       >  Retirement"
            		},
            		question: {
            			
            			text: "How are your retirement assets invested?"
            		},
            		additionalInfo: {
            					...
            					options: {
                                    ...
                                    click: function () {
                                        ...
                                        try {
            								...
            								var exceptionRet = self.options.wizard.loadPage("Page7_7");
                                            if (exceptionRet !== null) {
