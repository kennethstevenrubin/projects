...
define(["App/prototypes",
        ...
        var functionRet = function Page4_16(optionsOverride) {
            ...
            self.inherits(PageRowBase, {
            	...
            	itemList: [{
                    ...
                    text: "529",
                    selected: optionsOverride.wizard.options.wizData.assets.collegeAccounts.accounts[optionsOverride.wizard.options.wizData.index].type === "529"
                }, {

                    text: "Other college savings",
                    selected: optionsOverride.wizard.options.wizData.assets.collegeAccounts.accounts[optionsOverride.wizard.options.wizData.index].type === "Other college savings"
                }],
                configuration: {
            	...
            	rows : {
            		...
            		question: {
            			...
            			text: "What type of account is " + optionsOverride.wizard.options.wizData.assets.collegeAccounts.accounts[optionsOverride.wizard.options.wizData.index].name + "?"
            		},
            		additionalInfo: {
            				...
            				comboSelection: {
                                ...
                                options: {
                                    ...
                                    label: {
                                        ...
                                        text: (optionsOverride.wizard.options.wizData.assets.collegeAccounts.accounts[optionsOverride.wizard.options.wizData.index].type === "") ? "Select..." : optionsOverride.wizard.options.wizData.assets.collegeAccounts.accounts[optionsOverride.wizard.options.wizData.index].type,
                                        selected: (optionsOverride.wizard.options.wizData.assets.collegeAccounts.accounts[optionsOverride.wizard.options.wizData.index].type === "") ? false : true
                                        ...
                                        try {
                                        	...
                                        	if (optionsOverride.wizard.options.rlPopup === undefined) {
	                                            ...
	                                            optionsOverride.wizard.options.rlPopup = {
	                                                    ...
	                                                    haveSelection: self.options.wizard.options.wizData.assets.collegeAccounts.accounts[optionsOverride.wizard.options.wizData.index].type,
	                                                    rlList: []
	                                            };
            					...
            					options: {
                                    ...
                                    click: function () {
                                        ...
                                        try {
                                        	...
                                        	self.options.wizard.options.wizData.assets.collegeAccounts.accounts[self.options.wizard.options.wizData.index].type = self.options.configuration.comboSelection.instance.options.label.text;
                                    ...
                                    enabled: (optionsOverride.wizard.options.wizData.assets.collegeAccounts.accounts[optionsOverride.wizard.options.wizData.index].type === "") ? false : true,
                                    left: 310,
                                    top: 280,
                                    width: 170,
                                    height: 30
            		...
            		previousSkipLinks: {
            			...
            			previousClick: function () {
                            ...
                            try {
                            	...
                            	// Any children < 30 y.o.? If so, go to 4_15; else 4_14.
                            	var pageId = "Page4_14";
