...
define(["App/prototypes",
        ...
        var functionRet = function Page5_10(optionsOverride) {
            ...
            self.inherits(PageRowBase, {
            	...
            	itemList: [{
                    ...
                    text: "Checking",
                    selected: optionsOverride.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].type === "Checking"
                }, {

                    text: "Savings",
                    selected: optionsOverride.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].type === "Savings"
                }, {

                    text: "Other bank account",
                    selected: optionsOverride.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].type === "Other bank account"
                }],
                configuration: {
            	...
            	rows : {
            		...
            		question: {
            			...
            			text: "What type of account is " + optionsOverride.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].name + "?"
            		},
            		additionalInfo: {
            				...
            				comboSelection: {
                                ...
                                options: {
                                    ...
                                    label: {
                                        ...
                                        text: (optionsOverride.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].type === "") ? "Select..." : optionsOverride.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].type,
                                        selected: (optionsOverride.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].type === "") ? false : true
                                        ...
                                        try {
                                        	...
                                        	if (optionsOverride.wizard.options.rlPopup === undefined) {
	                                            ...
	                                            optionsOverride.wizard.options.rlPopup = {
	                                                    ...
	                                                    haveSelection: self.options.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].type,
	                                                    rlList: []
	                                            };
            					...
            					options: {
                                    ...
                                    click: function () {
                                        ...
                                        try {
                                        	...
                                        	self.options.wizard.options.wizData.assets.otherBankAccounts.accounts[self.options.wizard.options.wizData.index].type = self.options.configuration.comboSelection.instance.options.label.text;
                                    ...
                                    enabled: (optionsOverride.wizard.options.wizData.assets.otherBankAccounts.accounts[optionsOverride.wizard.options.wizData.index].type === "") ? false : true,
                                    left: 310,
                                    top: 280,
                                    width: 170,
                                    height: 30
