...
define(["App/prototypes",
        ...
        var functionRet = function Page4_4(optionsOverride) {
            ...
            self.inherits(PageRowBase, {
            	...
            	itemList: [{
                    ...
                    text: "IRA",
                    selected: optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].type === "IRA"
                }, {

                    text: "Keogh",
                    selected: optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].type === "Keogh"
                }, {

                    text: "401(k)",
                    selected: optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].type === "401(k)"
                }, {

                    text: "403(b)",
                    selected: optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].type === "403(b)"
                }, {

                    text: "Other retirement account",
                    selected: optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].type === "Other retirement account"
                }],
                configuration: {
            	...
            	rows : {
            		...
            		question: {
            			...
            			text: "What type of account is " + optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].name + "?"
            		},
            		additionalInfo: {
            				...
            				comboSelection: {
                                ...
                                options: {
                                    ...
                                    label: {
                                        ...
                                        text: (optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].type === "") ? "Select..." : optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].type,
                                        selected: (optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].type === "") ? false : true
                                        ...
                                        try {
                                        	...
                                        	if (optionsOverride.wizard.options.rlPopup === undefined) {
	                                            ...
	                                            optionsOverride.wizard.options.rlPopup = {
	                                                    ...
	                                                    haveSelection: self.options.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].type,
	                                                    rlList: []
	                                            };
            					...
            					options: {
                                    ...
                                    click: function () {
                                        ...
                                        try {
                                        	...
                                        	self.options.wizard.options.wizData.assets.retirementAccounts.accountsSelf[self.options.wizard.options.wizData.index].type = self.options.configuration.comboSelection.instance.options.label.text;
                                    ...
                                    enabled: (optionsOverride.wizard.options.wizData.assets.retirementAccounts.accountsSelf[optionsOverride.wizard.options.wizData.index].type === "") ? false : true,
                                    left: 310,
                                    top: 280,
                                    width: 170,
                                    height: 30
