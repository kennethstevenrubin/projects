    ...
    function (SectionTabBase,
        ...
        var functionRet = function SectionAssetPools(optionsOverride) {
                ...
                try {
                    ...
                    if (self.options.renderData.length === 1) {
                        ...
                        if (targetCanvas !== null && currentCanvas !== null) {
                            ...
                            ctx.fillStyle = self.options.chart.centerCircleFillStyle;
                            ctx.beginPath();
                            ctx.moveTo(middle, middle);
                            ...
                            ctx.lineWidth = 2;
                            ctx.fillStyle = self.options.chart.targetFill;
                            ctx.font = self.options.chart.targetFont;
                            ctx.fillText('Target',
                                    middle,
                                    middle);
                    ...
                    for (var i = 0; i < self.options.renderData.length; i++) {
                        ...
                        for (var k = 0; k < apIth.renderChunks.length; k++) {
                            ...
                            if (chunkIth.side) {
                                ...
                                contextRender.fillStyle = self.options.pools.positiveChunkColor;
                                contextRender.strokeStyle = self.options.pools.positiveChunkColor;
                                ...
                                contextRender.fillStyle = self.options.pools.negativeChunkColor;
                                contextRender.strokeStyle = self.options.pools.negativeChunkColor;
                                contextRender.beginPath();
            ...
            self.getHeight = function () {
                ...
                return self.options.assetPools.rowHeight * (self.options.renderData.length) +
